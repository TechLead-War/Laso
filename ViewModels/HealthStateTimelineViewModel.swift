...
final class HealthStateTimelineViewModel {
    ...
    func color(for label: String) -> (r: Double, g: Double, b: Double) {
        switch label {
        case "Recovery": return (0.2, 0.8, 0.4)
        case "Peak Performance": return (0.2, 0.5, 1.0)
        case "Stressed": return (1.0, 0.3, 0.3)
        case "Under-Slept": return (0.6, 0.3, 0.8)
        case "Active": return (0.3, 0.9, 0.6)
        case "Fatigued": return (0.8, 0.6, 0.2)
        case "Resting": return (0.5, 0.7, 0.9)
