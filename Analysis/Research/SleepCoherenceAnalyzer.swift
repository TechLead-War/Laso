    ...
    static func generateInsights(context: AnalysisContext) -> [Insight] {
        ...
        if coherenceTrend == .declining && (priorCoherence - recentCoherence) >= 10 {
            insights.append(InsightFactory.make(
                ...
                recommendation: "A \(String(format: "%.0f", priorCoherence - recentCoherence))-point drop in sleep coherence over 2 weeks may reflect increased stress, irregular schedule, or early signs of illness. This pattern often appears before overt symptoms.",
                severity: .warning,
                trend: .declining,
