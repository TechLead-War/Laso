...
enum UserLevel: Int, CaseIterable, Comparable {
    ...
    var color: Color {
        switch self {
        case .newcomer:  Color(red: 0.80, green: 0.50, blue: 0.20)  // bronze
        case .explorer:  Color(red: 0.75, green: 0.75, blue: 0.78)  // silver
        case .committed: Color(red: 1.00, green: 0.84, blue: 0.00)  // gold
        case .dedicated: Color(red: 0.90, green: 0.91, blue: 0.98)  // platinum
        case .champion:  Color(red: 0.72, green: 0.95, blue: 1.00)  // diamond
        case .legend:    Color(red: 0.85, green: 0.65, blue: 1.00)  // gradient/special
        }
    }
